...
{
    private readonly string _connectionString = @"Server=DESKTOP-4Q61549\SQLEXPRESS03;Database=QL_BanGiay_Final;Integrated Security=True;TrustServerCertificate=True;";
