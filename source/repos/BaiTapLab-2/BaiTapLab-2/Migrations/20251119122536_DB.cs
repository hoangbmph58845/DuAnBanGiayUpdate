    ...
    public partial class DB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DangKyMonHoc", x => new { x.MonHocsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_DangKyMonHoc_MonHocs_MonHocsId",
                        column: x => x.MonHocsId,
                        principalTable: "MonHocs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DangKyMonHoc_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DangKyMonHoc_StudentsId",
                table: "DangKyMonHoc",
                column: "StudentsId");
